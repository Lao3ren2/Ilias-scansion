In sources sind die heruntergeladenen Texte und die Verarbeitung in eine csv, die alle Zeilen des Textes enthält.

In syllabification wird damit eine Tabelle gemacht, in der die Silben des Verses getrennt sind.
